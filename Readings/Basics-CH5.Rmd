...
<1> Solution to Dramatic Class Imbalance: *stratified sampling* - the training/test split is conducted separately within each class and then these subsamples are combined into the overall training and test set. 
...
Note2: There is very little downside to using stratified sampling. 
